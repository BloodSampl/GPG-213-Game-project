...
public class ScrollSnapper : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    ...
    [Tooltip("Center of the screen")]
    public GameObject pageCenter;
    ...
    //public LevelInfo[] levelColors;
    //public Color[] levelColor;

    //public Color[] themeColor1;
    //public Color[] themeColor2;
    //public Image[] objColor1;
    //public Image[] objColor2;
    ...
    void Update()
    {
        //if (levelMusic[0] == null)
        //{
        //    levelMusic[0] = GameObject.Find("Garden").GetComponent<AudioSource>();
        //}
        //if (levelMusic[1] == null)
        //{
        //    levelMusic[1] = GameObject.Find("Alone Remix").GetComponent<AudioSource>();
        //}
        //if (levelMusic[2] == null)
        //{
        //    levelMusic[2] = GameObject.Find("Cube").GetComponent<AudioSource>();
        //}
        ...
        //        Camera.main.backgroundColor = levelColors[_currentPage].backColor;
        //        ThemeController.instance.themeColor = levelColors[_currentPage];

        //        for (int i = 0; i < objColor1.Length; i++)
        //        {
        //            objColor1[i].color = levelColors[_currentPage].tabColor;
        //        }

        //        for (int j = 0; j < objColor2.Length; j++)
        //        {
        //            objColor2[j].color = levelColors[_currentPage].iconColor;
        //        }
        //        anim[_currentPage].SetBool("Selected", true);
        ...
        //        //Play music
        //        for (int j = 0; j < levelMusic.Length; j++)
        //        {
        //            if (j == _currentPage)
        //            {
        //                if (!levelMusic[_currentPage].isPlaying)
        //                {
        //                    levelMusic[_currentPage].Play();
        //                }
        //                continue;
        //            }
        //            levelMusic[j].Stop();
        ...
        //		if (_currentPage == 0 ) {
        //			Camera.main.backgroundColor = levelColor [0];
        //				anim[0].SetBool ("Selected", true);
        //				anim[1].SetBool ("Selected", false);
        //				anim[2].SetBool ("Selected", false);
        //			if (!levelMusic [_currentPage].isPlaying) {	
        //				levelMusic [0].Play ();
        //			}
        //			levelMusic [1].Stop ();
        ...
        //			Camera.main.backgroundColor = levelColor [1];
        //			anim[0].SetBool ("Selected", false);
        //			anim[1].SetBool ("Selected", true);
        //			anim[2].SetBool ("Selected", false);
        //			if (!levelMusic [_currentPage].isPlaying) {	
        //				levelMusic [1].Play ();
        //			}
        ...
        //			Camera.main.backgroundColor = levelColor [2];
        //			anim[0].SetBool ("Selected", false);
        //			anim[1].SetBool ("Selected", false);
        //			anim[2].SetBool ("Selected", true);
        //			if (!levelMusic [_currentPage].isPlaying) {	
        //				levelMusic [2].Play ();
        //			}
        //			
    ...
    private void LerpToPage(int aPageIndex)
    {
        ...
        else if (aPageIndex == _pagePositions.Count - 1)
        {
